  ...
  <div class="l_inner">
      ...
      <div class="report-content">
        <div class="report-content-left">
          <ul class="report-box">
            ...
            <li class="report-box-list">詳　　細：<a href="https://www.javada.or.jp/jigyou/gino/zenkoku/index.html">中央職業能力開発協会ホームページ</a></li>
          ...
          <ul class="report-box-second">
            ...
            <li class="report-box-list">とび部門以外の成績は、中央職業能力開発協会技能五輪詳細ページをご覧下さい。</li>
          </ul>
        </div>   
    ...
    <section class="report sec_inner">
      ...
      <p class="report-sinbun-txt">日鳶連では、都道府県連、国土交通省・厚生労働省はじめ関係官庁、関係企業等から投稿や資料提供をいただき、<br>
        ...
        今年度発行分については<a href="http://www.nittobiren.or.jp/kain/kaiin.html">会員のページ</a>よりご覧ください。</p>
    </section>
  </div><!-- /l_inner -->
</div><!-- flex_inner -->
<?php get_footer(); ?>