...
<div class="page_cover">
  <h1 class="page_ttl">入会案内</h1>
</div>
<div class="flex_inner">
  <?php get_sidebar();?>
  <div class="l_inner">
    <section class="join sec_inner">
      <h2 class="h2_ttl">入会案内</h2>
      <p class="join-txt">日鳶連は各都道府県連一覧にてご案内の通り、全国各県連から構成されております。<br>
        また、県連によっては、組合から構成されております。<br>
        入会をご希望の方は、最寄りの地域組合または各都道府県連に入会していただくことにより、<br>
        日鳶連の会員になることができます。<br>
        なお、特定技能外国人の受け入れにつきましては<a href="">こちら</a>をご確認ください。</p>
    </section>
    
    <section class="join sec_inner">
      <h2 class="h2_ttl">会員資格</h2>
      <p class="join-txt">会員の資格は、定款により「当会の目的に賛同する鳶・土工工事業に携わる者」と定められております。</p>
    </section>
    
    <section class="join sec_inner">
      <h2 class="h2_ttl">入会の手続き</h2>
