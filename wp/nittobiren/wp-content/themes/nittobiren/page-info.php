  ...
  <div class="l_inner">
    <section class="info sec_inner">
      ...
      <div class="new-topics-item">
        ...
        <span class="new-topics-item-link-category">講習関連</span>
        <p class="new-topics-item-link-txt">登録鳶・土工基幹技能者講習６月東京開催の会場が変更となりました。<a class="c_red" href="<?php echo get_theme_file_uri() ?>/kikan_first">新規</a>・<a class="c_red" href="<?php echo get_theme_file_uri() ?>/kikan_second">更新</a></p>
      </div>
      ...
      <div class="new-topics-item">
        ...
        <span class="new-topics-item-link-category">講習関連</span>
        <p class="new-topics-item-link-txt">登録鳶・土工基幹技能者講習の<a class="c_red" href="<?php echo get_theme_file_uri() ?>/kikan_first">新規講習</a>、<a class="c_red" href="<?php echo get_theme_file_uri() ?>/kikan_second">更新講習</a>のページを更新しました。</p></p>
      </div>
      <div class="new-topics-item">
      ...
      <div class="new-topics-item">
        ...
        <span class="new-topics-item-link-category">講習関連</span>
        <p class="new-topics-item-link-txt"><a class="c_red" href="<?php echo get_theme_file_uri() ?>/report">活動報告</a>のページを更新しました。</p>
      </div>
      <div class="new-topics-item">
      ...
      <div class="new-topics-item">
        ...
        <span class="new-topics-item-link-category">講習関連</span>
        <p class="new-topics-item-link-txt"><a class="c_red" href="http://www.nittobiren.or.jp/kain/kaiin.html">会員のページ</a>を更新しました。</p>
      </div>
      <div class="new-topics-item">
