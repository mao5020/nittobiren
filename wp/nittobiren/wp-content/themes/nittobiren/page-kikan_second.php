...
<div class="flex_inner">
  ...
  <div class="l_inner">
    ...
    <section class="sec_inner">
      ...
      <ul class="kikan-box">
        <li class="kikan-box-list">(1)登録鳶・土工基幹技能者修了者</li>
        <li class="kikan-box-list">(2)前回、日本躯体にて受講された方も、当会にて更新講習を受講することが出来ます。</li>
        <li class="kikan-box-list">(3)修了証記載の有効期限の1年前から受講可能です。</li>
        <li class="kikan-box-list">(4)修了証記載の有効期限を経過した場合、６か月以内に限り更新講習を受講することができます。ただし、有効期限経過後更新講習会を受講し資格を再取得するまでの間、資格は失効されますのでご注意ください。</li>
      </ul>
      ...
      <ul class="kikan-box">
        <li class="kikan-box-list">講義（3時間）　／　修了試験（30分）</li>
      </ul>
