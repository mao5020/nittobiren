...
<div class="flex_inner">
  ...
  <div class="l_inner">
    ...
    <section class="lecture sec_inner">
      <h2 class="h2_ttl">技能講習</h2>
      <div class="lecture-content">
        <p class="lecture-txt">
          労働安全衛生法第６１条第１項の政令で定める業務に係る技能講習。<br>
          当会登録種目は以下のとおり。
        </p>
      </div>
    ...
    <section class="sec_inner">
      <h2 class="h2_ttl">各種目登録完了日一覧</h2>
      <p class="lecture-table-txt">※全種目登録満了時、更新予定</p>
      <div class="sp-scroll">
        ...
        <table class="C_kikan-table" border="1">
          <tbody>
            ...
            <tr>
              <td rowspan="8">1</td>
              <td rowspan="8">北海道</td>
              <td rowspan="8">北海道労働局</td>
              <td>足場</td>
              <td>北労安教第485号</td>
              <td rowspan="3">2025年1月22日</td>
            </tr>
            <tr>
              <td>鉄骨</td>
              <td>北労安教第486号</td>
            ...
            <tr>
              <td rowspan="2">2</td>
              <td rowspan="2">青森</td>
              <td rowspan="2">青森労働局</td>
              <td>足場</td>
              <td>第35号</td>
              <td rowspan="2">2024年3月30日</td>
            </tr>
            <tr>
              <td>地山土止め</td>
              <td>第126号</td>
            ...
            <tr>
              <td rowspan="4">8</td>
              <td rowspan="4">千葉</td>
              <td rowspan="4">千葉労働局</td>
              <td>足場</td>
              <td>千登録第21号</td>
              <td rowspan="4">2024年3月30日</td>
            </tr>
            <tr>
              <td>地山土止め</td>
              <td>千登録第19号</td>
            ...
            <tr>
              <td rowspan="3">10</td>
              <td rowspan="3">神奈川</td>
              <td rowspan="3">神奈川労働局</td>
              <td>足場</td>
              <td>3</td>
              <td rowspan="3">2024年3月30日</td>
            </tr>
            <tr>
              <td>地山土止め</td>
              <td>253</td>
            ...
            <tr>
              <td rowspan="6">20</td>
              <td rowspan="6">香川</td>
              <td rowspan="6">香川労働局</td>
              <td>足場</td>
              <td>香労登録第55号</td>
              <td rowspan="6">2024年3月30日</td>
            </tr>
            <tr>
              <td>型枠</td>
              <td>香労登録第53号</td>
            ...
            <tr>
              <td rowspan="4">25</td>
              <td rowspan="4">沖縄</td>
              <td rowspan="4">沖縄労働局</td>
              <td>足場</td>
              <td>第118号</td>
              <td rowspan="3">2024年3月31日</td>
            </tr>
            <tr>
              <td>玉掛け</td>
              <td>第65-2号</td>
